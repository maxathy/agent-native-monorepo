...
| 9   | Playwright E2E against the full compose stack       | `implemented` | `e2e.yml:50-90` brings up `docker compose --profile full` and points the suite at the console container via `E2E_BASE_URL`.                                                                                                                                                                                                                   | P0-A  |
